...
import static com.example.todoapplication.R.id.date;
...
public class AddItem extends AppCompatActivity {
    ...
    /**
     * Displays the time in the text view time
     * @param hour hour
     * @param minute minute
     */
    ...
    /**
     * Save item and send data to MAINACTIVITY
     * @param view view
     * @throws ParseException
     */
