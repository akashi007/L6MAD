...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Collects the data of the tasks in the database
     */
    public void getData() {
    ...
    /**
     * Returns the categoru data in the database
     */
    ...
    /**
     * Opens the settings meny for viewing and categories
     *
     * @param V
     */
    ...
    /**
     * Open the activity to add the item
     *
     * @param v
     */
    ...
    /**
     * Displays in red the data of the item if the date has already passed
     */
    ...
    /**
     * item thata should be displayed according to its category
     *
     * @param item
     * @return
     */
    ...
    /**
     *  Allows to display the tasks according to the restrictions of the user(status, date, categories etc...)
     */
    ...
    /**
     * Change the status of a task to do
     *
     * @param v
     */
    ...
    /**
     * Pass a category in visible or invisible
     *
     * @param v
     */
    ...
    /**
     * Allows you to prepare a notification
     *
     * @param notification
     * @param delay
     */
    ...
    /**
     * Allows the user to receive notifications about his spots
     * @param content the content of the otification
     * @return lder
     */
    ...
    /**
     * Returns the arraylist containing the categories
     *
     * @return the array list containing the category and categories
     */
    ...
    /**
     * Check if a category has been deleted and update the tasks if it is.
     */
    ...
    /**
     * Allows you to add a category via a menu
     *
     * @param v
     */
